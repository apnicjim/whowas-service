...
public class FuncTypeSafeMatchers {
    ...
    public static <K extends Comparable<K>> Matcher<Interval<K>> contains(Interval<K> containee) {
        return new FuncTypeSafeMatcher<>(
                ...
                , (container, description) -> description.appendText(containee + " is contained by " + container)
        );
    }
}
